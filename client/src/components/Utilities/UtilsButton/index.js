...
import { faCalendar, faCalculator, faCloud, faPassport } from '@fortawesome/free-solid-svg-icons';
...
const UtilsButton = (props) => {
    ...
    return (
        ...
        <div className="flex center col utils_button" onClick={clickHandler} >
            ...
            { props.icon === "Password Generator" && <span className="flex center"><FontAwesomeIcon icon={faPassport} /></span> }
