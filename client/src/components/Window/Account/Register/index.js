        ...
        <div className="login_spacer flex col center">
            ...
            <form>
                ...
                <div className="flex row center login_input">
                    ...
                    <p className="login_input_placeholder">Email</p>
                ...
                <div className="flex row center login_input">
                    ...
                    <p className="login_input_placeholder">Confirm Password</p>
                ...
                <div className="flex row center">
                    ...
                    <div ref={buttonRef} className="flex row center login_button">
                        ...
                        <button onMouseEnter={buttonHover} onMouseLeave={reverseButton}>Submit</button>
